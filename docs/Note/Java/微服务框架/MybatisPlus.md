...
![image-20231205105600030](/assets/images/Java/微服务框架/MybatisPlus/image-20231205105600030.png)
...
![image-20231205111756256](/assets/images/Java/微服务框架/MybatisPlus/image-20231205111756256.png)

![image-20231205111813944](/assets/images/Java/微服务框架/MybatisPlus/image-20231205111813944.png)

复制 `资料\mp-demo` 到刚刚创建的空工程下；（不要包含空格和特殊字符）。然后用IDEA工具导入打开，项目结构如下：

![image-20231205111829711](/assets/images/Java/微服务框架/MybatisPlus/image-20231205111829711.png)

![image-20231205111924267](/assets/images/Java/微服务框架/MybatisPlus/image-20231205111924267.png)

注意配置一下项目的JDK版本为JDK11。 `Ctrl + Alt + Shift + S`打开项目结构设置：

![image-20231205112914268](/assets/images/Java/微服务框架/MybatisPlus/image-20231205112914268.png)

### 1.1.2、初始化数据

将 `资料\mp.sql` 文件使用 MySQL 图形界面工具导入并执行里面的数据库脚本；创建如下两张表：

![image-20231205113337300](/assets/images/Java/微服务框架/MybatisPlus/image-20231205113337300.png)

### 1.1.3、修改数据库连接

在刚刚导入的工程中；找到 `application.yaml`文件；修改jdbc连接参数为自己数据库信息。

![image-20231205113603931](/assets/images/Java/微服务框架/MybatisPlus/image-20231205113603931.png)
...
![image-20231205114336592](/assets/images/Java/微服务框架/MybatisPlus/image-20231205114336592.png)

因此我们自定义的Mapper只要实现了这个`BaseMapper`，就无需自己实现单表CRUD了。 修改`mp-demo`中的`com.itheima.mp.mapper`包下的`UserMapper`接口，让其继承`BaseMapper`：

![image-20231205114440476](/assets/images/Java/微服务框架/MybatisPlus/image-20231205114440476.png)
...
![image-20231205154355598](/assets/images/Java/微服务框架/MybatisPlus/image-20231205154355598.png)
...
![image-20231205165938240](/assets/images/Java/微服务框架/MybatisPlus/image-20231205165938240.png)
...
![image-20231205172221612](/assets/images/Java/微服务框架/MybatisPlus/image-20231205172221612.png)

参数中的`Wrapper`就是条件构造的抽象类，其下有很多默认实现，继承关系如图：

![image-20231205174149517](/assets/images/Java/微服务框架/MybatisPlus/image-20231205174149517.png)

`Wrapper`的子类`AbstractWrapper`提供了where中包含的所有条件构造方法：

![image-20231205193354393](/assets/images/Java/微服务框架/MybatisPlus/image-20231205193354393.png)

而QueryWrapper在AbstractWrapper的基础上拓展了一个select方法，允许指定查询字段：

![image-20231205193442011](/assets/images/Java/微服务框架/MybatisPlus/image-20231205193442011.png)

而UpdateWrapper在AbstractWrapper的基础上拓展了一个set方法，允许指定SQL中的SET部分：

![image-20231205193601518](/assets/images/Java/微服务框架/MybatisPlus/image-20231205193601518.png)
...
![image-20231205203305874](/assets/images/Java/微服务框架/MybatisPlus/image-20231205203305874.png)
...
![image-20231206103039651](/assets/images/Java/微服务框架/MybatisPlus/image-20231206103039651.png)
...
![image-20231206103321161](/assets/images/Java/微服务框架/MybatisPlus/image-20231206103321161.png)
...
![image-20231206104024837](/assets/images/Java/微服务框架/MybatisPlus/image-20231206104024837.png)
...
![image-20231206104226471](/assets/images/Java/微服务框架/MybatisPlus/image-20231206104226471.png)
...
![image-20231206104321627](/assets/images/Java/微服务框架/MybatisPlus/image-20231206104321627.png)
...
![image-20231206104356450](/assets/images/Java/微服务框架/MybatisPlus/image-20231206104356450.png)
...
![image-20231206104450638](/assets/images/Java/微服务框架/MybatisPlus/image-20231206104450638.png)
...
![image-20231206110311123](/assets/images/Java/微服务框架/MybatisPlus/image-20231206110311123.png)
...
![image-20231206160823614](/assets/images/Java/微服务框架/MybatisPlus/image-20231206160823614.png)
...
![image-20231206201207936](/assets/images/Java/微服务框架/MybatisPlus/image-20231206201207936.png)
...
![image-20231206201351881](/assets/images/Java/微服务框架/MybatisPlus/image-20231206201351881.png)

可以看到使用了批处理以后，比逐条新增效率提高了近10倍左右，性能还是不错的。

不过；我们简单查看一下 `MybatisPlus`的源码：

![image-20231206201857439](/assets/images/Java/微服务框架/MybatisPlus/image-20231206201857439.png)
...
![image-20231206202743784](/assets/images/Java/微服务框架/MybatisPlus/image-20231206202743784.png)
...
![image-20231207112552950](/assets/images/Java/微服务框架/MybatisPlus/image-20231207112552950.png)
...
![image-20231219164729208](/assets/images/Java/微服务框架/MybatisPlus/image-20231219164729208.png)

点击上述的 `Config Database` 配置数据库连接如下：

![image-20231219165012532](/assets/images/Java/微服务框架/MybatisPlus/image-20231219165012532.png)

点击 `Code Generator` 配置代码生成信息如下：

![image-20231219165832246](/assets/images/Java/微服务框架/MybatisPlus/image-20231219165832246.png)
...
![image-20231206204119935](/assets/images/Java/微服务框架/MybatisPlus/image-20231206204119935.png)
...
![image-20231207150106304](/assets/images/Java/微服务框架/MybatisPlus/image-20231207150106304.png)
...
![image-20231207151650438](/assets/images/Java/微服务框架/MybatisPlus/image-20231207151650438.png)
...
![image-20231207153312318](/assets/images/Java/微服务框架/MybatisPlus/image-20231207153312318.png)

![image-20231207153430096](/assets/images/Java/微服务框架/MybatisPlus/image-20231207153430096.png)
...
![image-20231207153833204](/assets/images/Java/微服务框架/MybatisPlus/image-20231207153833204.png)

打开swagger测试接口，查看返回值发现；枚举类型也被处理：

![image-20231207154405261](/assets/images/Java/微服务框架/MybatisPlus/image-20231207154405261.png)

## 3.4、Json类型处理器

数据库的user表中有一个`info`字段，是JSON类型：

![image-20231207154612668](/assets/images/Java/微服务框架/MybatisPlus/image-20231207154612668.png)
...
![image-20231207154708018](/assets/images/Java/微服务框架/MybatisPlus/image-20231207154708018.png)
...
![image-20231207155153028](/assets/images/Java/微服务框架/MybatisPlus/image-20231207155153028.png)
...
![image-20231207161442043](/assets/images/Java/微服务框架/MybatisPlus/image-20231207161442043.png)

同时也修改 `UserVO` 中的`info`属性的类型为 `UserInfo`

![image-20231207155607800](/assets/images/Java/微服务框架/MybatisPlus/image-20231207155607800.png)
...
![image-20231207161258421](/assets/images/Java/微服务框架/MybatisPlus/image-20231207161258421.png)

同样的；在web页面中测试接口：

![image-20231207161855534](/assets/images/Java/微服务框架/MybatisPlus/image-20231207161855534.png)
...
![image-20231207170007468](/assets/images/Java/微服务框架/MybatisPlus/image-20231207170007468.png)
...
![image-20231207170138037](/assets/images/Java/微服务框架/MybatisPlus/image-20231207170138037.png)
...
- **登录**
  ...
  ![image-20231208163830522](/assets/images/Java/微服务框架/MybatisPlus/image-20231208163830522.png)

- **商品搜索**

  ![image-20231208163916766](/assets/images/Java/微服务框架/MybatisPlus/image-20231208163916766.png)

- **购物车**

  ![image-20231208174350751](/assets/images/Java/微服务框架/MybatisPlus/image-20231208174350751.png)
...
![image-20231208170355585](/assets/images/Java/微服务框架/MybatisPlus/image-20231208170355585.png)

### 5.2.2、导入工程

将 `资料\黑马商城\hmall` 文件夹复制到自己的工作空间；然后再导入到IDEA中。

![image-20231208170555955](/assets/images/Java/微服务框架/MybatisPlus/image-20231208170555955.png)

### 5.2.3、启动前端

将 `资料\黑马商城\hmall-nginx` 放置到一个没有中文、空格等路径的文件夹下；然后再启动nginx；

![image-20231208170802452](/assets/images/Java/微服务框架/MybatisPlus/image-20231208170802452.png)
...
- 在搜索页面中实现 `加入购物车` 功能
  ...
  ![image-20231208174458686](/assets/images/Java/微服务框架/MybatisPlus/image-20231208174458686.png)
